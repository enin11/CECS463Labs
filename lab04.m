%% LAB 04 - Frequency Domain Representation

%Marc Dominic Cabote
%CECS 463 Fall 2018

close all; clear all; format compact; clc; %clear init
disp('Lab #4 - Frequency Domain Representation');
...
%b
disp('(1b): x(n) - 1.7678x(n-1) +1.5625x(n-2) +1.134y(n-1) -0.64y(n-2)');
a = [1,-1.134,0.64]; 
b = [1,-1.7678,1.5625];
Q = 500; w = [-Q:1:Q]*(pi/Q);
...
%% Problem 2
disp('Problem 2'); 
disp(' y(n) = 0.5x(n) -0.8y(n-1)+0.95y(n-2)');
a = [1,0.8,-0.95];
b = 0.5;
Q = 500; w = [-Q:1:Q]*(pi/Q);
